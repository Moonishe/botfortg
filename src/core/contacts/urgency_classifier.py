...
Прочитай сообщение и определи его срочность.

Категории:
- urgent — срочное: требует немедленного ответа, критическая ситуация.
  Маркеры (примеры): срочно, тревога, ты где, позвони, алло, help, SOS, пропал, много !!! или CAPS.
- important — важное: обида, злость, вопрос требующий внимания, эмоциональное сообщение.
  Маркеры (примеры): обиделась, бесит, достал, почему, что случилось, серьёзно.
- normal — обычное: болтовня, мемы, новости, приветствия, «ок», «ага».

Правила:
1. Понимай СМЫСЛ сообщения, не только ключевые слова.
2. Ждёт реакции прямо сейчас → urgent. Эмоционален без срочности → important.
3. Спокойное/бытовое/короткое («ок», «ага», мемы) → normal.
