...
SCENE_SYSTEM_PROMPT = """Ты — AI-ассистент. Твоя задача — превратить
разрозненные факты памяти в связный нарратив сцены.

Дано: список фактов, извлечённых из переписки с контактом.
Создай ОДНУ сцену — связный эпизод (2-4 предложения, настоящее время).
Сохрани важные детали: имена, даты, цифры. Не выдумывай.

Верни ТОЛЬКО валидный JSON (без markdown-обёрток):
{
  "scene_title": "название (3-7 слов)",
