...
1. **Fragility.** When one extra's transitive dependency becomes
   ...
   back to a stripped tier тАФ losing 10+ unrelated extras at once.
...
* **Offline detection.** If the install fails (offline, mirror down,
  ...
  :class:`FeatureUnavailable` with the actual pip stderr тАФ no silent
...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    # тФАтФАтФА Inference providers тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    # Native Anthropic SDK тАФ needed when provider=anthropic (not via
    # OpenRouter / aggregators which use the openai SDK).
    "provider.anthropic": ("anthropic==0.87.0",),  # CVE-2026-34450, CVE-2026-34452
    # AWS Bedrock provider
    "provider.bedrock": ("boto3==1.42.89",),
    # Microsoft Foundry тАФ Entra ID auth (managed identity, workload identity,
    ...
    # тФАтФАтФА Web search backends тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    "search.exa": ("exa-py==2.10.2",),
    "search.firecrawl": ("firecrawl-py==4.17.0",),
    "search.parallel": ("parallel-web==0.4.2",),

    # тФАтФАтФА TTS providers тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    ...
    # тФАтФАтФА Speech-to-text providers тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    ...
    # тФАтФАтФА Image generation backends тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    "image.fal": ("fal-client==0.13.1",),

    # тФАтФАтФА Memory providers тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    "memory.honcho": ("honcho-ai==2.0.1",),
    "memory.hindsight": ("hindsight-client==0.6.1",),

    # тФАтФАтФА Messaging platforms (lazy-installable on demand) тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    ...
    # "Can not decode content-encoding: br" тАФ see #12511 / #15744.
    ...
    # WeCom callback-mode adapter тАФ parses untrusted XML POST bodies. Pulls
    ...
    # Microsoft Teams adapter тАФ microsoft-teams-apps pulls a heavy tree
    ...
    # тФАтФАтФА Terminal backends тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    "terminal.modal": ("modal==1.3.4",),
    "terminal.daytona": ("daytona==0.155.0",),

    # тФАтФАтФА Skills тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    ...
    # тФАтФАтФА Tools тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
    ...
    "tool.dashboard": (
        ...
        "starlette==1.0.1",  # CVE-2026-48710 (BadHost) тАФ keep lazy-install in sync with pyproject [web]
    ),
...
# Conservative regex for spec validation тАФ package name plus optional
...
def _pkg_name_from_spec(spec: str) -> str:
    ...
    ``"slack-bolt>=1.18.0,<2"`` тЖТ ``"slack-bolt"``
    ``"mautrix[encryption]>=0.20"`` тЖТ ``"mautrix"``
    """
...
def _specifier_from_spec(spec: str) -> str:
    ...
    ``"honcho-ai==2.0.1"`` тЖТ ``"==2.0.1"``
    ``"mautrix[encryption]>=0.20,<1"`` тЖТ ``">=0.20,<1"``
    ``"package"`` тЖТ ``""`` (no version constraint)
    """
...
def _is_satisfied(spec: str) -> bool:
    ...
    if not spec_tail:
        # Bare ``"package"`` тАФ no version constraint, presence is enough.
        return True
    ...
    try:
        ...
        # packaging unavailable тАФ fall back to "installed counts as satisfied".
        return True

    try:
        return Version(installed) in SpecifierSet(spec_tail)
    except (InvalidSpecifier, InvalidVersion, Exception):
        # Malformed spec or installed version we can't parse тАФ don't churn.
        return True
...
def _venv_pip_install(specs: tuple[str, ...], *, timeout: int = 300) -> _InstallResult:
    """Install ``specs`` into the active venv using uv тЖТ pip тЖТ ensurepip ladder.
    ...
    # Tier 1: uv (preferred тАФ fast, doesn't need pip in the venv)
...
def ensure(feature: str, *, prompt: bool = True) -> None:
    ...
    batch) get prompt=False and skip the confirmation тАФ config flag is
    ...
    # braces тАФ the keys-in-LAZY_DEPS check above already constrains this.
    for spec in missing:
    ...
    # Under the TUI we skip the prompt and proceed тАФ lazy installs are
    ...
    if not result.success:
        ...
        if snippet:
            # Clip to a readable size тАФ pip can dump pages of resolution traces.
...
def refresh_active_features(*, prompt: bool = False) -> dict[str, str]:
    ...
    Returns a ``{feature: status}`` map where status is one of:
        ``"current"``  тАФ pins already satisfied, no install run
        ``"refreshed"`` тАФ pins were stale, reinstall succeeded
        ``"failed: <reason>"`` тАФ install attempt failed; caller decides
                                  whether to surface it (we don't raise)
        ``"skipped: <reason>"`` тАФ gated off (config flag, user decline)
