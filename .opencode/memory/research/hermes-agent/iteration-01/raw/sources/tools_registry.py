...
# every get_definitions() is pure waste тАФ external state changes on human
...
class ToolRegistry:
        ...
        with self._lock:
            ...
            if existing and existing.toolset != toolset:
                ...
                if both_mcp:
                    ...
                    # Reject shadowing тАФ prevent plugins/MCP from overwriting
    ...
    def get_definitions(self, tool_names: Set[str], quiet: bool = False) -> List[dict]:
        ...
        """
        result = []
        # Per-call cache on top of the 30 s TTL тАФ handles repeat probes of the
        ...
        for name in sorted(tool_names):
            ...
            if entry.check_fn:
                ...
                if not check_results[entry.check_fn]:
                    ...
                    continue
            # Ensure schema always has a "name" field тАФ use entry.name as fallback
    ...
    def get_schema(self, name: str) -> Optional[dict]:
        ...
        doesn't matter тАФ only the schema content does.
        """
        entry = self.get_entry(name)
    ...
    def get_emoji(self, name: str, default: str = "тЪб") -> str:
